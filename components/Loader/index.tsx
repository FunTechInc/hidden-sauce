...
export const Loader = ({
   ...
   useEffect(() => {
      if (delay === 0) return;
      const timeoutId = window.setTimeout(() => setIsView(true), delay);
            ...
            {loader === "skeleton" ? (
               <div
                  style={{
                     ...
                     animationDuration: skeleton?.animationDuration || "1.6s",
               ...
               <div
                  style={{
                     ...
                     animationDuration: circular?.animationDuration || "1.6s",
                     animationTimingFunction:
                        circular?.animationTimingFunction || "linear",
                     position: "absolute",
                     top: 0,
                     bottom: 0,
                     left: 0,
